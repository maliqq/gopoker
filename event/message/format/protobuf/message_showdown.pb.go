...
// source: event/message/format/protobuf/message_showdown.proto
// DO NOT EDIT!
...
// Hand - hand info
type Hand struct {
	Rank             *Rank  `protobuf:"varint,1,req,enum=protobuf.Rank" json:"Rank,omitempty"`
...
func (m *ShowHand) GetPlayer() string {
...
func (m *ShowCards) GetPlayer() string {
	if m != nil && m.Player != nil {
		return *m.Player
	}
	return ""
...
func init() {
	proto.RegisterEnum("protobuf.Rank", Rank_name, Rank_value)
}
